...
<div class="w-full grow py-10 flex items-center justify-center flex-col">
    {#if $currentUser}
        ...
        <form method="POST" action="?/quiz" class="mt-10 lg:w-min flex justify-center gap-5 mx-auto flex-wrap lg:flex-nowrap">
            <button disabled={!$currentUser.verified} formaction="?/flashcards" class="w-full md:w-96 relative group hover:variant-filled-primary card p-5 py-24 md:py-32 card-hover">
            ...
            <button disabled={!$currentUser.verified} formaction="?/quiz" class="w-full md:w-96 relative group hover:variant-filled-primary card p-5 py-24 md:py-32 card-hover">
